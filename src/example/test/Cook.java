...
import example.test.Beverage.Beverage;
import example.test.Waffle.Waffle;
import example.test.Waffle.WaffleDecorator.*;
import example.test.Waffle.WaffleDecorator.NormalChocolate;
import example.test.Waffle.WaffleDecorator.Strawberry;
import example.test.Waffle.WaffleDecorator.WhiteChocolate;
